...
class zh_CN {
  static Map<String, String> keys() {
    return {
      ...
      /// request
      'sadPanda': 'Sad Panda(无响应数据). 解决参考Github Wiki: https://github.com/jiangtian616/JHenTai/wiki/%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98，如果你看得懂中文请不要到处截图询问。',
      ...
      'tapZoneStyle': '点击区域样式',
      'tapZoneStyleHint': '自定义阅读页的点击翻页区域',
      'tapZonePreset': '预设',
      'tapZonePresetClassic': '经典三分',
      'tapZonePresetVertical': '上下翻页',
      'tapZoneRatio': '区域大小',
      'tapZoneAction': '点击区域动作',
      'tapZoneActionNone': '无',
      ...
      'tapZonePreview': '预览',
      'tapZoneGuideHint': '点击任意处关闭引导，可在 设置→阅读 中配置区域',
